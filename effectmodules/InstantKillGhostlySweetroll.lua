...
module.fire = function(moushit,handle)
	...
	local function hitfunc(part,proj)
		...
		head.face:remove()
		local sweetroll = ss.Food_Sweetroll:Clone()
		sweetroll.Parent =workspace
		sweetroll.Handle.CFrame = hrpcf+Vector3.new(math.random(-10,10),0,math.random(-10,10))
		sweetroll.Handle.Anchored = false
